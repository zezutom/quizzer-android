...
/**
 * This is to work around a known Android bug with overlapping rows in a GridView.
 * <p/>
...
public class NoRowOverlapGridView extends GridView {
    ...
    public NoRowOverlapGridView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public NoRowOverlapGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public NoRowOverlapGridView(Context context) {
        super(context);
    }
